...
[/GLOBAL_GUARDRAILS_V1]";
        ...
        CancellationToken ct = default)
    {
        ...
        var loop = new AgentLoopConfig
        {
            ...
            EnablePromptInjectionGuard = request.Loop.EnablePromptInjectionGuard,
            EnablePiiProtection = request.Loop.EnablePIIProtection,
    ...
    private static AgentDetailDto MapToDetailDto(AgentDefinition agent) => new()
    {
        ...
        Loop = new LoopConfigDto
        {
            ...
            EnablePromptInjectionGuard = agent.LoopConfig.EnablePromptInjectionGuard,
            EnablePIIProtection = agent.LoopConfig.EnablePiiProtection,
